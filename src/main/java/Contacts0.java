...
public class Contacts0 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println(CONSOLE_WALL + " [Command entered:" + userCommand + "]");
            String feedback;
            ...
            case "add":
                ...
                if (decodeResult == null) {
                    feedback = String.format("Invalid command format: %1$s " + (System.lineSeparator() + CONSOLE_WALL + " ")
                            ...
                            + String.format("\tExample: %1$s", "add" + " John Doe p/98765432 e/johnd@gmail.com") + (System.lineSeparator() + CONSOLE_WALL + " "));
                    break;
                }
            ...
            case "help":
                feedback = (String.format("%1$s: %2$s", "add", "Adds a person to contacts.") + (System.lineSeparator() + CONSOLE_WALL + " ")
                        ...
                        + "p/" + "PHONE_NUMBER "
                        + "e/" + "EMAIL") + (System.lineSeparator() + CONSOLE_WALL + " ")
                        + String.format("\tExample: %1$s", "add" + " John Doe p/98765432 e/johnd@gmail.com") + (System.lineSeparator() + CONSOLE_WALL + " ")) + (System.lineSeparator() + CONSOLE_WALL + " ")
    ...
    private static void showWelcomeScreen() {
        System.out.println(CONSOLE_WALL + " ===================================================");
        System.out.println(CONSOLE_WALL + " ===================================================");
        System.out.println(CONSOLE_WALL + " Contacts - Version 1.0");
        System.out.println(CONSOLE_WALL + " Welcome to Contacts!");
        System.out.println(CONSOLE_WALL + " ===================================================");
    }
