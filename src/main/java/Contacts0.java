...
public class Contacts0 {
    ...
    public static void main(String[] args) {
        ...
        int count = 0;
        while (true) {
            String CONSTANT_WALL_SEPARATOR = "|| ";
            System.out.print(CONSTANT_WALL_SEPARATOR + "Enter command: ");
            ...
            case "add":
                ...
                if (decodeResult == null) {
                    feedback = String.format("Invalid command format: %1$s " + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                            + "%2$s", "add", String.format("%1$s: %2$s", "add", "Adds a person to contacts.") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                            + String.format("\tParameters: %1$s", "NAME "
                            + "p/" + "PHONE_NUMBER "
                            + "e/" + "EMAIL") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                            + String.format("\tExample: %1$s", "add" + " John Doe p/98765432 e/johnd@gmail.com") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR));
                    break;
                }
            ...
            case "list":
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    messageAccumulator.append('\t').append(String.format("%1$d. ", displayIndex))
                            ...
                            .append(System.lineSeparator()).append(CONSTANT_WALL_SEPARATOR);
                }
                String listAsString = messageAccumulator.toString();
                for (String m1 : new String[]{listAsString}) {
                    System.out.println(CONSTANT_WALL_SEPARATOR + m1);
                }
            ...
            case "clear":
                ...
                break;
            case "help":
                feedback = (String.format("%1$s: %2$s", "add", "Adds a person to contacts.") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + String.format("\tParameters: %1$s", "NAME "
                        + "p/" + "PHONE_NUMBER "
                        + "e/" + "EMAIL") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + String.format("\tExample: %1$s", "add" + " John Doe p/98765432 e/johnd@gmail.com") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)) + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + (String.format("%1$s: %2$s", "list", "Displays all persons as a list with index numbers.") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + String.format("\tExample: %1$s", "list") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)) + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + (String.format("%1$s: %2$s", "clear", "Clears all contacts.") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + String.format("\tExample: %1$s", "clear") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)) + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + (String.format("%1$s: %2$s", "exit", "Exits the program.")+ (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + String.format("\tExample: %1$s", "exit")) + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR) + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + (String.format("%1$s: %2$s", "help", "Shows program usage instructions.")+ (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
            ...
            default:
                feedback = String.format("Invalid command format: %1$s " + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + "%2$s", commandType, (String.format("%1$s: %2$s", "add", "Adds a person to contacts.") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + String.format("\tParameters: %1$s", "NAME "
                        + "p/" + "PHONE_NUMBER "
                        + "e/" + "EMAIL") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + String.format("\tExample: %1$s", "add" + " John Doe p/98765432 e/johnd@gmail.com") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)) + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + (String.format("%1$s: %2$s", "find", "Finds all persons whose names contain any of the specified "
                        + "keywords (case-sensitive) and displays them as a list with index numbers.") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + String.format("\tParameters: %1$s", "KEYWORD [MORE_KEYWORDS]") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + String.format("\tExample: %1$s", "find" + " alice bob charlie") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)) + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + (String.format("%1$s: %2$s", "list", "Displays all persons as a list with index numbers.") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + String.format("\tExample: %1$s", "list") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)) + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + (String.format("%1$s: %2$s", "clear", "Clears all contacts.") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + String.format("\tExample: %1$s", "clear") + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)) + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + (String.format("%1$s: %2$s", "exit", "Exits the program.")
                        + String.format("\tExample: %1$s", "exit")) + (System.lineSeparator() + CONSTANT_WALL_SEPARATOR)
                        + (String.format("%1$s: %2$s", "help", "Shows program usage instructions.")
                        + String.format("\tExample: %1$s", "help")));
                break;
            }
            for (String m : new String[]{feedback, "==================================================="}) {
                System.out.println(CONSTANT_WALL_SEPARATOR + m);
            }
        }
    }
